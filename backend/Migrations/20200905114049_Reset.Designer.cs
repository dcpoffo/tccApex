...
namespace API.Migrations
{
    ...
    [Migration("20200905114049_Reset")]
    partial class Reset
    {
            ...
            modelBuilder.Entity("API.models.NaoConformidade", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClienteId = 1,
                            DataAbertura = new DateTime(2020, 9, 5, 8, 40, 48, 316, DateTimeKind.Local).AddTicks(4158),
                            ProblemaId = 1,
                            ProdutoId = 1,
                            Quantidade = 10.0
                        },
                        new
                        {
                            Id = 2,
                            ClienteId = 2,
                            DataAbertura = new DateTime(2020, 9, 5, 8, 40, 48, 319, DateTimeKind.Local).AddTicks(27),
                            ProblemaId = 2,
                            ProdutoId = 2,
                            Quantidade = 100.0
                        },
                        new
                        {
                            Id = 3,
                            ClienteId = 2,
                            DataAbertura = new DateTime(2020, 9, 5, 8, 40, 48, 319, DateTimeKind.Local).AddTicks(251),
                            ProblemaId = 4,
                            ProdutoId = 3,
                            Quantidade = 50.0
                        });
